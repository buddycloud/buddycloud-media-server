...
public abstract class AbstractCapabilitiesDecorator implements
		CapabilitiesDecorator {
	...
	public boolean isUserAllowed(String affiliationType) {
		...
		return this.decorator.isUserAllowed(affiliationType)
				|| isAllowed(affiliationType);
	}
