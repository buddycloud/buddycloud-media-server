...
public class DiscoverInfo extends IQ {
	...
	private DataForm discoveryExtension;
    ...
    /**
     * Add a service discovery extension (XEP-0128)
     * 
     * @param dataform
     */
    public void addDiscoveryExtension(DataForm x) {
    	this.discoveryExtension = x;
    }
    ...
    public String getChildElementXML() {
        ...
        if (this.discoveryExtension != null) {
        	buf.append(this.discoveryExtension.toXML());
        }
